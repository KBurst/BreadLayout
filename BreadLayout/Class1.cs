...
namespace BreadLayout
{
    public class BreadLayout : ContentView
    {
        /// <summary>
        ...
        /// <summary>
        /// Item Collection containing the BreadLayout.
        /// NOTE: This is used to allow the BreadLayout to complement the CarouselView, but isn't necessary for utilization. 
        /// </summary>
        ...
        private void PinchUpdated(object sender, PinchGestureUpdatedEventArgs pinchEventArgs)
        {
            ...
            switch (pinchEventArgs.Status)
            {
                ...
                case GestureStatus.Completed:
                    ...
                    break;
                default:
                    const string errorMessage = "Unknown Error with BreadLayout.PinchUpdated.";
        ...
        private void PanUpdated(object sender, PanUpdatedEventArgs panEventArgs)
        {
            ...
            switch (panEventArgs.StatusType)
            {
                ...
                case GestureStatus.Canceled:
                    break;
                default:
                    const string errorMessage = "Unknown Error with BreadLayout.PanUpdated.";
                    throw new ArgumentOutOfRangeException(nameof(sender), errorMessage);
            }
        }
